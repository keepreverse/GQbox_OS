...
export function createDemoDataSource(): DataSource {
  ...
  const dictionaries: DictionariesAPI = {
    ...
    get attributes(): CategoryAttribute[] {
      // Атрибуты категорий — пока статичны в src/data/dictionaries.ts,
      // но в новой архитектуре они должны приходить с бэка. TODO: добавить
      // отдельную таблицу/endpoint когда понадобится редактирование.
      return [];
    },
