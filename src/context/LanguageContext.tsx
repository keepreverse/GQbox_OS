...
const translations: Record<Language, Translations> = {
  ru: {
    ...
    'ai.welcome': 'Привет! Я помогу с описаниями, переводами и анализом данных. Что нужно сделать?',
  ...
  en: {
    ...
    'ai.welcome': 'Hi! I can help with descriptions, translations, and data analysis. What do you need?',
